...
db <- as.data.table(read.csv("S:/MNHS-Psych/ANDL-Lab-DGS-Study/data_for_manuscripts/tim_task_paper/experimental_data_COPYforR.csv"))
```
...
SCS2_alpha <- psych::alpha(db[, c("SCS.R.2_1", "SCS.R.2_2", "SCS.R.2_3", "SCS.R.2_4", "SCS.R.2_5", "SCS.R.2_6", "SCS.R.2_7", "SCS.R.2_8", "SCS.R.2_9", "SCS.R.2_10","SCS.R.2_11", "SCS.R.2_12", "SCS.R.2_13", "SCS.R.2_14", "SCS.R.2_15", "SCS.R.2_16", "SCS.R.2_17", "SCS.R.2_18", "SCS.R.2_19", "SCS.R.2_20")])
...
# Cronbachs alpha
SCS1_alpha <- psych::alpha(db[, c("SCS.R.1_1", "SCS.R.1_2", "SCS.R.1_3", "SCS.R.1_4", "SCS.R.1_5", "SCS.R.1_6", "SCS.R.1_7", "SCS.R.1_8", "SCS.R.1_9", "SCS.R.1_10", "SCS.R.1_11", "SCS.R.1_12", "SCS.R.1_13", "SCS.R.1_14", "SCS.R.1_15", "SCS.R.1_16", "SCS.R.1_17", "SCS.R.1_18", "SCS.R.1_19", "SCS.R.1_20")])
...
## reversal for ones where higher scores meant less support (1,2,5,7)
db[, SSES.1 := (6 - SSES.1)]
db[, SSES.2 := (3 - SSES.2)]
db[, SSES.5 := (5 - SSES.5)]
db[, SSES.7 := (6 - SSES.7)]
...
## alpha
SSES_alpha <- psych::alpha(db[, c("SSES.1", "SSES.2", "SSES.3", "SSES.4", "SSES.5", "SSES.6", "SSES.7")])
...
## alpha
SSGLBT_alpha <- psych::alpha(db[, c("SSGLBT.1", "SSGLBT.2", "SSGLBT.3", "SSGLBT.4")])
...
```{r}
## puberty alpha
MSPSS_P_alpha <- psych::alpha(db[, c("MSPSS.1.1_1", "MSPSS.1.1_2", "MSPSS.1.1_3", "MSPSS.1.1_4", "MSPSS.1.1_5", "MSPSS.1.1_6", "MSPSS.1.1_7", "MSPSS.2.1_1", "MSPSS.2.1_2", "MSPSS.2.1_3", "MSPSS.2.1_4", "MSPSS.2.1_5", "MSPSS.2.1_6")])

print(MSPSS_P_alpha$total)

## current alpha
MSPSS_C_alpha <- psych::alpha(db[, c("MSPSS.1.2_1", "MSPSS.1.2_2", "MSPSS.1.2_3", "MSPSS.1.2_4", "MSPSS.1.2_5", "MSPSS.1.2_6", "MSPSS.1.2_7", "MSPSS.2.2_1", "MSPSS.2.2_2", "MSPSS.2.2_3", "MSPSS.2.2_4", "MSPSS.2.2_5", "MSPSS.2.2_6")])
...
## puberty alpha
FCS_Palpha <- psych::alpha(db[, c("FCS.3.1_1", "FCS.3.1_2", "FCS.3.1_3", "FCS.3.1_4", "FCS.3.1_5")])
...
## current alpha
FCS_Calpha <- psych::alpha(db[, c("FCS.3.2_1", "FCS.3.2_2", "FCS.3.2_3", "FCS.3.2_4", "FCS.3.2_5")])
...
## alpha
EDS_alpha <- psych::alpha(db[, c("EDS.1_1", "EDS.1_2", "EDS.1_3", "EDS.1_4", "EDS.1_5", "EDS.1_6", "EDS.1_7", "EDS.1_8", "EDS.1_9")])
...
## alpha
BloomS_alpha <- psych::alpha(db[, c("BloomS_1", "BloomS_2", "BloomS_3", "BloomS_4", "BloomS_5")])
...
```{r}
## alpha
PDS_alpha <- psych::alpha(db[, c("Retro_PDS.1_1", "Retro_PDS.1_2", "Retro_PDS.1_3", "Retro_PDS.1_4", "Retro_PDS.1_5", "Retro_PDS.1_6", "Retro_PDS.1_7")]) 
...
## alpha
CTQ_alpha <- psych::alpha(db[, c("CTQ.1_1", "CTQ.1_2", "CTQ.1_3", "CTQ.1_4", "CTQ.1_5", "CTQ.1_6", "CTQ.1_7", "CTQ.1_8", "CTQ.1_9", "CTQ.1_10", "CTQ.1_11", "CTQ.1_12", "CTQ.1_13", "CTQ.1_14","CTQ.1_15", "CTQ.1_16", "CTQ.1_17", "CTQ.1_18", "CTQ.1_19", "CTQ.1_20", "CTQ.1_21", "CTQ.1_22", "CTQ.1_23", "CTQ.1_24", "CTQ.1_25", "CTQ.1_26", "CTQ.1_27", "CTQ.1_28", "CTQ.1_29", "CTQ.1_30", "CTQ.1_31", "CTQ.1_32")])
...
Code for the other versions can be found in "Questionnaires_experimental_ALL_DHEQ_VER".
...
db[, (vars) := lapply(.SD, function(x) as.numeric(as.character(x))), .SDcols = vars]

db$DHEQ_GE.Puberty_1 <- ifelse(db$DHEQ_GE.Puberty_1 == 0, 1, db$DHEQ_GE.Puberty_1)
db$DHEQ_GE.Puberty_2 <- ifelse(db$DHEQ_GE.Puberty_2 == 0, 1, db$DHEQ_GE.Puberty_2)
db$DHEQ_GE.Puberty_3 <- ifelse(db$DHEQ_GE.Puberty_3 == 0, 1, db$DHEQ_GE.Puberty_3)
db$DHEQ_GE.Puberty_4 <- ifelse(db$DHEQ_GE.Puberty_4 == 0, 1, db$DHEQ_GE.Puberty_4)
db$DHEQ_GE.Puberty_5 <- ifelse(db$DHEQ_GE.Puberty_5 == 0, 1, db$DHEQ_GE.Puberty_5)
db$DHEQ_GE.Puberty_6 <- ifelse(db$DHEQ_GE.Puberty_6 == 0, 1, db$DHEQ_GE.Puberty_6)
db$DHEQ_HD.Puberty_1 <- ifelse(db$DHEQ_HD.Puberty_1 == 0, 1, db$DHEQ_HD.Puberty_1)
db$DHEQ_HD.Puberty_2 <- ifelse(db$DHEQ_HD.Puberty_2 == 0, 1, db$DHEQ_HD.Puberty_2)
db$DHEQ_HD.Puberty_3 <- ifelse(db$DHEQ_HD.Puberty_3 == 0, 1, db$DHEQ_HD.Puberty_3)
db$DHEQ_HD.Puberty_4 <- ifelse(db$DHEQ_HD.Puberty_4 == 0, 1, db$DHEQ_HD.Puberty_4)
db$DHEQ_HD.Puberty_5 <- ifelse(db$DHEQ_HD.Puberty_5 == 0, 1, db$DHEQ_HD.Puberty_5)
db$DHEQ_HD.Puberty_6 <- ifelse(db$DHEQ_HD.Puberty_6 == 0, 1, db$DHEQ_HD.Puberty_6)
db$DHEQ_Vic.Puberty_1 <- ifelse(db$DHEQ_Vic.Puberty_1 == 0, 1, db$DHEQ_Vic.Puberty_1)
db$DHEQ_Vic.Puberty_2 <- ifelse(db$DHEQ_Vic.Puberty_2 == 0, 1, db$DHEQ_Vic.Puberty_2)
db$DHEQ_Vic.Puberty_3 <- ifelse(db$DHEQ_Vic.Puberty_3 == 0, 1, db$DHEQ_Vic.Puberty_3)
db$DHEQ_Vic.Puberty_4 <- ifelse(db$DHEQ_Vic.Puberty_4 == 0, 1, db$DHEQ_Vic.Puberty_4)
db$DHEQ_Vig.Puberty_1 <- ifelse(db$DHEQ_Vig.Puberty_1 == 0, 1, db$DHEQ_Vig.Puberty_1)
db$DHEQ_Vig.Puberty_2 <- ifelse(db$DHEQ_Vig.Puberty_2 == 0, 1, db$DHEQ_Vig.Puberty_2)
db$DHEQ_Vig.Puberty_3 <- ifelse(db$DHEQ_Vig.Puberty_3 == 0, 1, db$DHEQ_Vig.Puberty_3)
db$DHEQ_Vig.Puberty_4 <- ifelse(db$DHEQ_Vig.Puberty_4 == 0, 1, db$DHEQ_Vig.Puberty_4)
db$DHEQ_Vig.Puberty_5 <- ifelse(db$DHEQ_Vig.Puberty_5 == 0, 1, db$DHEQ_Vig.Puberty_5)
db$DHEQ_Vig.Puberty_6 <- ifelse(db$DHEQ_Vig.Puberty_6 == 0, 1, db$DHEQ_Vig.Puberty_6)
db$DHEQ_FO.Puberty_1 <- ifelse(db$DHEQ_FO.Puberty_1 == 0, 1, db$DHEQ_FO.Puberty_1)
db$DHEQ_FO.Puberty_2 <- ifelse(db$DHEQ_FO.Puberty_2 == 0, 1, db$DHEQ_FO.Puberty_2)
db$DHEQ_FO.Puberty_3 <- ifelse(db$DHEQ_FO.Puberty_3 == 0, 1, db$DHEQ_FO.Puberty_3)
db$DHEQ_FO.Puberty_4 <- ifelse(db$DHEQ_FO.Puberty_4 == 0, 1, db$DHEQ_FO.Puberty_4)
db$DHEQ_FO.Puberty_5 <- ifelse(db$DHEQ_FO.Puberty_5 == 0, 1, db$DHEQ_FO.Puberty_5)
db$DHEQ_FO.Puberty_6 <- ifelse(db$DHEQ_FO.Puberty_6 == 0, 1, db$DHEQ_FO.Puberty_6)
db$DHEQ_VT.Puberty_1 <- ifelse(db$DHEQ_VT.Puberty_1 == 0, 1, db$DHEQ_VT.Puberty_1)
db$DHEQ_VT.Puberty_2 <- ifelse(db$DHEQ_VT.Puberty_2 == 0, 1, db$DHEQ_VT.Puberty_2)
db$DHEQ_VT.Puberty_3 <- ifelse(db$DHEQ_VT.Puberty_3 == 0, 1, db$DHEQ_VT.Puberty_3)
db$DHEQ_VT.Puberty_4 <- ifelse(db$DHEQ_VT.Puberty_4 == 0, 1, db$DHEQ_VT.Puberty_4)
db$DHEQ_VT.Puberty_5 <- ifelse(db$DHEQ_VT.Puberty_5 == 0, 1, db$DHEQ_VT.Puberty_5)
db$DHEQ_VT.Puberty_6 <- ifelse(db$DHEQ_VT.Puberty_6 == 0, 1, db$DHEQ_VT.Puberty_6)
db$DHEQ_I.Puberty_1 <- ifelse(db$DHEQ_I.Puberty_1 == 0, 1, db$DHEQ_I.Puberty_1)
db$DHEQ_I.Puberty_2 <- ifelse(db$DHEQ_I.Puberty_2 == 0, 1, db$DHEQ_I.Puberty_2)
db$DHEQ_I.Puberty_3 <- ifelse(db$DHEQ_I.Puberty_3 == 0, 1, db$DHEQ_I.Puberty_3)
db$DHEQ_I.Puberty_4 <- ifelse(db$DHEQ_I.Puberty_4 == 0, 1, db$DHEQ_I.Puberty_4)

## Gender expression average
db[, DHEQ_V3_GE_Avg := rowMeans(.SD, na.rm = TRUE),
     .SDcols = c("DHEQ_GE.Puberty_1", "DHEQ_GE.Puberty_2", "DHEQ_GE.Puberty_3", "DHEQ_GE.Puberty_4", "DHEQ_GE.Puberty_5", "DHEQ_GE.Puberty_6")]
summary(db$DHEQ_V3_GE_Avg)
sd(db$DHEQ_V3_GE_Avg, na.rm = TRUE)

DHEQ_v3_GE_alpha <- psych::alpha(db[, c("DHEQ_GE.Puberty_1", "DHEQ_GE.Puberty_2", "DHEQ_GE.Puberty_3", "DHEQ_GE.Puberty_4", "DHEQ_GE.Puberty_5", "DHEQ_GE.Puberty_6")])
print(DHEQ_v3_GE_alpha$total)

## Harassment and discrimination average
db[, DHEQ_V3_HD_Avg := rowMeans(.SD, na.rm = TRUE),
     .SDcols = c("DHEQ_HD.Puberty_1", "DHEQ_HD.Puberty_2", "DHEQ_HD.Puberty_3", "DHEQ_HD.Puberty_4", "DHEQ_HD.Puberty_5", "DHEQ_HD.Puberty_6")]
summary(db$DHEQ_V3_HD_Avg)
sd(db$DHEQ_V3_HD_Avg, na.rm = TRUE)

DHEQ_v3_HD_alpha <- psych::alpha(db[, c("DHEQ_HD.Puberty_1", "DHEQ_HD.Puberty_2", "DHEQ_HD.Puberty_3", "DHEQ_HD.Puberty_4", "DHEQ_HD.Puberty_5", "DHEQ_HD.Puberty_6")])
print(DHEQ_v3_HD_alpha$total)

# Victimization average
db[, DHEQ_V3_Vic_Avg := rowMeans(.SD, na.rm = TRUE),
     .SDcols = c("DHEQ_Vic.Puberty_1", "DHEQ_Vic.Puberty_2", "DHEQ_Vic.Puberty_3", "DHEQ_Vic.Puberty_4")]
summary(db$DHEQ_V3_Vic_Avg)
sd(db$DHEQ_V3_Vic_Avg, na.rm = TRUE)

DHEQ_v3_Vic_alpha <- psych::alpha(db[, c("DHEQ_Vic.Puberty_1", "DHEQ_Vic.Puberty_2", "DHEQ_Vic.Puberty_3", "DHEQ_Vic.Puberty_4")])
print(DHEQ_v3_Vic_alpha$total)

# Vigilance average
db[, DHEQ_V3_Vig_Avg := rowMeans(.SD, na.rm = TRUE),
...
summary(db$DHEQ_V3_Vig_Avg)
sd(db$DHEQ_V3_Vig_Avg, na.rm = TRUE)

DHEQ_v3_Vig_alpha <- psych::alpha(db[, c("DHEQ_Vig.Puberty_1", "DHEQ_Vig.Puberty_2", "DHEQ_Vig.Puberty_3", "DHEQ_Vig.Puberty_4", "DHEQ_Vig.Puberty_5", "DHEQ_Vig.Puberty_6")])
print(DHEQ_v3_Vig_alpha$total)

# Family of origin average
db[, DHEQ_V3_FO_Avg := rowMeans(.SD, na.rm = TRUE),
     .SDcols = c("DHEQ_FO.Puberty_1", "DHEQ_FO.Puberty_2", "DHEQ_FO.Puberty_3", "DHEQ_FO.Puberty_4", "DHEQ_FO.Puberty_5", "DHEQ_FO.Puberty_6")]
summary(db$DHEQ_V3_FO_Avg)
sd(db$DHEQ_V3_FO_Avg, na.rm = TRUE)

DHEQ_v3_FO_alpha <- psych::alpha(db[, c("DHEQ_FO.Puberty_1", "DHEQ_FO.Puberty_2", "DHEQ_FO.Puberty_3", "DHEQ_FO.Puberty_4", "DHEQ_FO.Puberty_5", "DHEQ_FO.Puberty_6")])
print(DHEQ_v3_FO_alpha$total)

# Vicarious trauma average
db[, DHEQ_V3_VT_Avg := rowMeans(.SD, na.rm = TRUE),
     .SDcols = c("DHEQ_VT.Puberty_1", "DHEQ_VT.Puberty_2", "DHEQ_VT.Puberty_3", "DHEQ_VT.Puberty_4", "DHEQ_VT.Puberty_5", "DHEQ_VT.Puberty_6")]
summary(db$DHEQ_V3_VT_Avg)
sd(db$DHEQ_V3_VT_Avg, na.rm = TRUE)

DHEQ_v3_VT_alpha <- psych::alpha(db[, c("DHEQ_VT.Puberty_1", "DHEQ_VT.Puberty_2", "DHEQ_VT.Puberty_3", "DHEQ_VT.Puberty_4", "DHEQ_VT.Puberty_5", "DHEQ_VT.Puberty_6")])
print(DHEQ_v3_VT_alpha$total)

# Isolation average
db[, DHEQ_V3_I_Avg := rowMeans(.SD, na.rm = TRUE),
     .SDcols = c("DHEQ_I.Puberty_1", "DHEQ_I.Puberty_2", "DHEQ_I.Puberty_3", "DHEQ_I.Puberty_4")]
summary(db$DHEQ_V3_I_Avg)
sd(db$DHEQ_V3_I_Avg, na.rm = TRUE)

DHEQ_v3_I_alpha <- psych::alpha(db[, c("DHEQ_I.Puberty_1", "DHEQ_I.Puberty_2", "DHEQ_I.Puberty_3", "DHEQ_I.Puberty_4")])
print(DHEQ_v3_I_alpha$total)

# Total
db[, DHEQ_V3_Total_Avg := rowMeans(.SD, na.rm = TRUE),
     .SDcols = c("DHEQ_GE.Puberty_1", "DHEQ_GE.Puberty_2", "DHEQ_GE.Puberty_3", "DHEQ_GE.Puberty_4", "DHEQ_GE.Puberty_5", "DHEQ_GE.Puberty_6",
          "DHEQ_HD.Puberty_1", "DHEQ_HD.Puberty_2", "DHEQ_HD.Puberty_3", "DHEQ_HD.Puberty_4", "DHEQ_HD.Puberty_5", "DHEQ_HD.Puberty_6",
          "DHEQ_Vic.Puberty_1", "DHEQ_Vic.Puberty_2", "DHEQ_Vic.Puberty_3", "DHEQ_Vic.Puberty_4",
          "DHEQ_Vig.Puberty_1", "DHEQ_Vig.Puberty_2", "DHEQ_Vig.Puberty_3", "DHEQ_Vig.Puberty_4", "DHEQ_Vig.Puberty_5", "DHEQ_Vig.Puberty_6",
          ...
          "DHEQ_VT.Puberty_1", "DHEQ_VT.Puberty_2", "DHEQ_VT.Puberty_3", "DHEQ_VT.Puberty_4", "DHEQ_VT.Puberty_5", "DHEQ_VT.Puberty_6",
          "DHEQ_I.Puberty_1", "DHEQ_I.Puberty_2", "DHEQ_I.Puberty_3", "DHEQ_I.Puberty_4")]
summary(db$DHEQ_V3_Total_Avg)
sd(db$DHEQ_V3_Total_Avg, na.rm = TRUE)

DHEQ_v3_Total_alpha <- psych::alpha(db[, c("DHEQ_GE.Puberty_1", "DHEQ_GE.Puberty_2", "DHEQ_GE.Puberty_3", "DHEQ_GE.Puberty_4", "DHEQ_GE.Puberty_5", "DHEQ_GE.Puberty_6",
          "DHEQ_HD.Puberty_1", "DHEQ_HD.Puberty_2", "DHEQ_HD.Puberty_3", "DHEQ_HD.Puberty_4", "DHEQ_HD.Puberty_5", "DHEQ_HD.Puberty_6",
          "DHEQ_Vic.Puberty_1", "DHEQ_Vic.Puberty_2", "DHEQ_Vic.Puberty_3", "DHEQ_Vic.Puberty_4",
          "DHEQ_Vig.Puberty_1", "DHEQ_Vig.Puberty_2", "DHEQ_Vig.Puberty_3", "DHEQ_Vig.Puberty_4", "DHEQ_Vig.Puberty_5", "DHEQ_Vig.Puberty_6",
          "DHEQ_FO.Puberty_1", "DHEQ_FO.Puberty_2", "DHEQ_FO.Puberty_3", "DHEQ_FO.Puberty_4", "DHEQ_FO.Puberty_5", "DHEQ_FO.Puberty_6",
...
## alpha
YASB_alpha <- psych::alpha(db[, c("YASB_1", "YASB_2", "YASB_3", "YASB_4", "YASB_5", "YASB_6", "YASB_7", "YASB_8", "YASB_9", "YASB_10", "YASB_11", "YASB_12", "YASB_13", "YASB_14")]) 
...
Run the above code to get the scoring of all questionnaires, and then proceed with the following to get correlations. Ensure to use db as the 3rd version of the DHEQ is used

```{r}
library(knitr)
library(kableExtra)

social_support_matrix <- round(cor(db[, .(SCSR2_Total, SCSR1_Total, SSES_Avg, SSGLBT_Avg, MSPSS_P_TOTAL, MSPSS_C_TOTAL, FCS_PAvg, FCS_CAvg)]), 2)
...
minority_stress_matrix <- round(cor(db[, .(EDS_Total, DHEQ_V3_GE_Avg, DHEQ_V3_HD_Avg, DHEQ_V3_Vic_Avg, DHEQ_V3_Vig_Avg, DHEQ_V3_FO_Avg, DHEQ_V3_VT_Avg, DHEQ_V3_I_Avg, DHEQ_V3_Total_Avg)]), 2)
...
# Export
```{r}
dbFINAL <- db[, c("ID", "EDS_Total", "DASS21_CDepressionFINAL", "DASS21_CTotal", "birth_sex", "session1_age", "session2_age", "agediff", "preintq_age", "Post.Vid.Qs_1", "Post.Vid.Qs_2", "Post.Vid.Qs_3", "Post.Vid.Qs_5", "Post.Vid.Qs_6", "Own.Vid", "Peer.vid", "Disconnect_contrast", "Other_contrast", "DHEQ_V3_GE_Avg", "DHEQ_V3_HD_Avg", "DHEQ_V3_Vic_Avg", "DHEQ_V3_Vig_Avg", "DHEQ_V3_FO_Avg", "DHEQ_V3_I_Avg", "DHEQ_V3_VT_Avg", "DHEQ_V3_Total_Avg", "FCS_PAvg", "FCS_CAvg", "MSPSS_C_SO", "MSPSS_C_Fa", "MSPSS_C_Fr", "MSPSS_C_TOTAL", "MSPSS_P_SO", "MSPSS_P_Fa", "MSPSS_P_Fr", "MSPSS_P_TOTAL", "SSGLBT_Avg", "SSES_Avg", "SCSR2_Total", "SCSR1_Total")]

write.csv(dbFINAL, "S:/MNHS-Psych/ANDL-Lab-DGS-Study/data_for_manuscripts/tim_task_paper/experimental_scored_data.csv")
```
